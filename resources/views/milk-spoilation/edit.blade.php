            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex align-items-center">
                        <h4>{{trans('file.Update Milk Spoilation')}}</h4>
                    </div>
                    <div class="card-body">
                        {!! Form::open(['route' => ['milk-spoilation-update', $milk_spoilation->id], 'method' => 'post', 'files' => true, 'id' => 'milk-spoilation-form']) !!}
                            <div class="row">
                                <div class="col-12">
                                    <div class="row">
                                        <div class="col-6">
                                            ...
                                            <div class="form-group">
                                                <div class="row">
                                                    ...
                                                    <div class="col-9">
                                                        ...
                                                        @else
                                                            <input type="text" name="range"  required value="{{$milk_spoilation->date}}" class="form-control float-right" id="reservation" />
                                                        @endif
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="col-12">
                                            ...
                                            <div class="col-9">
                                                <select name="supplier_id" class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title="Select supplier...">
                                                    ...
                                                    @foreach($lims_supplier_list as $key => $value)
                                                        <option value="{{$value->id}}" @if($milk_spoilation->supplier_id == $value->id) selected @endif required>{{$value->name}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-9">
                                                <input type="text" name="remarks" value="{{$milk_spoilation->description}}" required class="form-control" >
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                            ...
                                            <div class="box-inner">
                                                <div class="box-content">
                                                    <table class="table table-striped table-bordered bootstrap-datatable responsive invoice-table" id="myTable">
                                                        ...
                                                        <tbody id="TBody">
                                                            @php
                                                                $data   =   $milk_spoilation->data  ?   json_decode($milk_spoilation->data) :   null;
                                                            @endphp
                                                                ...
                                                                <tr id="TRow">
                                                                    ...
                                                                    <td>
                                                                        <input class="form-control combine num_only_integer_quantity milk_rate vertical"
                                                                            type="text"  name="rate[]" tabIndex="-1" value="{{$data_value->rate}}" onkeyup="calc(this)" required style="width:100px;"/>
                                                                    </td>
                                                                    <td>
                                                                        <input class="form-control combine num_only_integer_quantity amount vertical"
                                                                            type="text"  name="amount[]" tabIndex="-1" value="{{$data_value->amount}}" readonly style="width:100px;"/>
                                                                    </td>
                                                                </tr>
                                                            @endforeach
                                                        </tbody>
                                                        ...
                                                        <tfoot id="tfoot">
                                                            <tr>
                                                                ...
                                                                <td colspan="2">
                                                                    <input type="text" id="total_qty" class="form-control total_value" value="{{$milk_spoilation->total_qty}}" readonly tabIndex="-1" name="total_qty" style="width:190px;">
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td colspan="3"></td>
                                                                ...
                                                                <td colspan="2" class="discount-td">
                                                                    <input readonly class="form-control form-control discount-val num_only_decimal vertical" value="{{$milk_spoilation->total_amount}}" id="total_amount"
