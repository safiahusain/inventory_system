        ...
        <div class="side-navbar-wrapper">
          ...
          <div class="main-menu">
            <ul id="side-main-menu" class="side-menu list-unstyled">
              ...
              @endif
                <li><a href="#milk_spolation" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-card"></i><span>{{trans('file.Milk Spoilation')}}</span></a>
                    <ul id="milk_spolation" class="collapse list-unstyled ">
                        <li id="milk-spoilation-create-menu"><a href="{{route('milk-spoilation-index')}}">{{trans('file.Milk Spoilation List')}}</a></li>
                        <li id="milk-spoilation-create-menu"><a href="{{route('milk-spoilation-create')}}">{{trans('file.Add Milk Spoilation')}}</a></li>
                    </ul>
                </li>
              <?php
              ...
              <li hidden><a href="#setting" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-gear"></i><span>{{trans('file.settings')}}</span></a>
