                                        ...
                                        <tbody>
                                            @foreach ($stock as $key =>  $value)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input class="form-control {{"$key-m_qty"}}" type="text" id="{{"$key-m_qty"}}" name="{{"$key-m_qty"}}" onkeyup="calc(this)" value="">&nbsp;
                                                        <span class="qty_message"></span>
                                                    </td>
                                                    <td>
                                                        <input class="form-control {{"$key-e_qty"}}" type="text" id="{{"$key-e_qty"}}" name="{{"$key-e_qty"}}" onkeyup="calc(this)" @if($key == 'wanda') readonly @endif value="">
                                                    </td>
                                                    <td>
                                                        <input class="form-control {{"$key-milk_rate"}}" type="text" id="{{"$key-milk_rate"}}" name="{{"$key-milk_rate"}}" onkeyup="calc(this)" value="">
                                                    </td>
                                                    <td>
                                                        <input class="form-control {{"$key-pk_default_value"}}" type="text" id="{{"$key-pk_default_value"}}" name="{{"$key-pk_default_value"}}" onkeyup="calc(this)" @if($key == 'wanda') readonly @endif value="">
                                                    </td>
                                                    <td>
                                                        <input class="form-control {{"$key-pk_enter_value"}}" type="text" id="{{"$key-pk_enter_value"}}" name="{{"$key-pk_enter_value"}}" onkeyup="calc(this)" @if($key == 'wanda') readonly @endif value="">
                                                    </td>
                                                    <td>
                                                        <input class="form-control {{"$key-pk_amount"}}" type="text" id="{{"$key-pk_amount"}}" name="{{"$key-pk_amount"}}" readonly value="">
                                                    </td>
                                                    <td>
                                                        <input class="form-control {{"$key-amount"}}" type="text" id="{{"$key-amount"}}" name="{{"$key-amount"}}" readonly value="">
                                                    </td>
                                                </tr>
                                            @endforeach
                                        </tbody>
